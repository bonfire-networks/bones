...
```
cd extensions
git clone https://github.com/bonfire-networks/bones.git {your-extension-name-here}
cd {your-extension-name-here} 
```
- Rename all the modules names to match your extension name:
    - Find & replace Bones -> Bonfire.YourExtensionName 
    - Find & replace bones -> bonfire_your_extension_name
- Rename the `bones.exs` config file to match your extension name `bonfire_your_extension_name.exs`
...
- Add `use_if_enabled(Bones.Web.Routes)` in your app's `Router` module
